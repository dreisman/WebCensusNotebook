...
def check_top_url(connection, top_url):
...
def get_top_urls_with_third_party_domain(connection, tp_domain):
...
def get_third_party_responses_by_domain(connection, top_url):
...
def get_cookie_syncs_v2(connection, top_url, cookie_length=8):
...
def get_cookie_syncs_on_domain(connection, top_url):
